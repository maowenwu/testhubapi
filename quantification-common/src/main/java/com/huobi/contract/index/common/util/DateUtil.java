...
public class DateUtil {
    ...
    public static final String DATE_FORMAT_YYYY_MM_DDTHH_MI_SS = "yyyy-MM-dd'T'HH:mm:ss";
     ...
     *
     * @param one 1 格式：1990-01-01 12:00:00
     * @param two 2 格式：2009-01-01 12:00:00
     ...
     * @return
     */
    public static Date getRecentFiveMinuteTimeInterval() {
        Calendar calendar = Calendar.getInstance();
        calendar.add(Calendar.DAY_OF_MONTH, -1);
        int s = calendar.get(Calendar.MINUTE);
        int minute = (s / 5) * 5;
     ...
     * @return
     */
    public static Date getRecentTenMinuteTimeInterval() {
        Calendar calendar = Calendar.getInstance();
        calendar.add(Calendar.DAY_OF_MONTH, -1);
        int s = calendar.get(Calendar.MINUTE);
    ...
    public static Date getSpecifiedDayBefore(Integer count) {
        Calendar calendar = Calendar.getInstance();
        calendar.add(Calendar.DAY_OF_MONTH, -count);
        return calendar.getTime();
    }

    public static Date getSpecifiedDayBefore(Date date, Integer count) {
        Calendar calendar = Calendar.getInstance();
     ...
     * @return
     */
    public static Date getMinuteBefore(Integer minute) {
        Calendar calendar = Calendar.getInstance();
        calendar.add(Calendar.MINUTE, -minute);
        return calendar.getTime();
    }

    public static Date getSecondBefore(Date date, Integer second) {
        Calendar calendar = Calendar.getInstance();
        calendar.setTime(date);
    ...
    public static Date timeSeconds2Date(long seconds) {
    ...
    public static Date getPreviousGFriday(){
        int i =0;
        while (true){
            Date preday = DateUtil.getSpecifiedDayBefore(i);
            Calendar aCalendar = Calendar.getInstance();
     ...
     * @return
     */
    public static Date parseUTCTimeToDate(String date) {
        SimpleDateFormat df = new SimpleDateFormat(DateUtil.DATE_FORMAT_YYYY_MM_DDTHH_MI_SS);
        Date result = null;
        try {
            result = df.parse(date);
            Calendar calendar = Calendar.getInstance();
            calendar.setTime(result);
            System.out.println(DateUtil.parseDateToStr(calendar.getTime(), DateUtil.DATE_TIME_FORMAT_YYYY_MM_DD_HH_MI_SS));
