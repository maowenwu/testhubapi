...
public class DateUtils {
    ...
    public static Date parseUTCTimeToDate(String date) {
        SimpleDateFormat df = new SimpleDateFormat(DateUtils.DATE_FORMAT_YYYY_MM_DDTHH_MI_SS);
        Date result = null;
        try {
            result = df.parse(date);
            Calendar calendar = Calendar.getInstance();
            calendar.setTime(result);
            System.out.println(DateUtils.parseDateToStr(calendar.getTime(), DateUtils.DATE_TIME_FORMAT_YYYY_MM_DD_HH_MI_SS));
