...
import com.huobi.contract.index.api.ExchangeRateCalcServiceImpl;
...
public class MD5Util {
	private static final Logger logger = LoggerFactory.getLogger(ExchangeRateCalcServiceImpl.class);
