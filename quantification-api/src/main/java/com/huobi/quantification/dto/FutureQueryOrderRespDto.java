...
public class FutureQueryOrderRespDto implements Serializable {

    private Map<Long, DataBean> data = new HashMap<>();

    public Map<Long, DataBean> getData() {
        return data;
    }

    public void setData(Map<Long, DataBean> data) {
        this.data = data;
    }
