...
import cn.huobi.framework.model.*;
import cn.huobi.framework.service.UserService;
import com.github.pagehelper.PageHelper;
import com.github.pagehelper.PageInfo;
import com.huobi.quantification.dao.BossShiroUserMapper;
...
public class UserServiceImpl implements UserService {
    ...
    @Autowired
    BossShiroUserMapper bossShiroUserMapper;
...
//			user.setPassword("123456");
    ...
    public int restPwd(Integer id) {
        ...
        if (user != null) {
            ...
            Md5PasswordEncoder passEnc = new Md5PasswordEncoder();
            user.setPassword(passEnc.encodePassword(sysDictDao.selectRestPwd().getSysValue(), user.getUserName()));
        } else {
            return 0;
        }
        return userDao.restPwd(user);
    }
...
//	}
    ...
    @Override
    public PageInfo<BossShiroUser> selectPage(BossShiroUser entity, PageInfo<BossShiroUser> pageInfo) {
        PageHelper.startPage(pageInfo.getPageNum(), pageInfo.getPageSize());
        List<BossShiroUser> list = bossShiroUserMapper.selectList(entity);
