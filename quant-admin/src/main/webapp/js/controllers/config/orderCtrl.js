...
angular.module('inspinia',['uiSwitch']).controller('orderCtrl',function($scope,$http,$state,$stateParams,i18nService,SweetAlert,$document){
	...
	$scope.orderGrid = {
		...
		columnDefs: [
            ...
            {field: 'contractFee', displayName: '合约手续费'},
            {field: 'spotFee', displayName: '现货手续费'},
            {field: 'deliveryFee', displayName: '交割手续费'},
            {field: 'expectYields', displayName: '期望收益率'},
            {field: 'priceStep', displayName: '合并价格'},
            {field: 'asksMaxAmount', displayName: '最大卖单量'},
            {field: 'bidsMaxAmount', displayName: '最大买单量'},
